...
<div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Create Role</h5>
            @if (count($errors) > 0)
            ...
            @csrf
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        {!! Form::text('name', null, ['placeholder' => 'Name', 'required', 'class' => 'form-control', 'id' => 'role-create-input-name']) !!}
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        {{ Form::select('organization_name', ['none' => 'Select an organization'] + collect($organizations)->mapWithKeys(function ($name, $id) {
                            return [$id+1 => $name];
                        })->all(), $selectedOrganizationId, ['id' => 'organization_name', 'class' => 'form-select', 'required']) }}
