  ...
  <!--  Body Wrapper -->
       ...
       <div class="container-fluid">
        ...
        <div class="row mb-3">
          ...
          <form id="diagnosisForm" method="POST" action="{{ route('update.diagnosis.medication', ['diagnosisId' => $diagnosisId]) }}">
                  @foreach ($diagnosis as $singleDiagnosis)
    @if ($singleDiagnosis->diagnosis_id == $diagnosisId)       
          <div class="container-fluid">
            <div class="card">
              <div class="card-body">
                <div class="row">
    ...
    <div class="col-md-6">
        ...
        <input class="form-check-input flexSwitchCheckChecked" type="checkbox" name="active" id="flexSwitchCheckChecked" {{ $singleDiagnosis->active == 0 ? 'disabled' : '' }} {{ old('active', $singleDiagnosis->active) == 1 ? 'checked' : null }}>
<label class="form-check-label" for="flexSwitchCheckChecked">Active</label>
    ...
    <div class="row">
        <div class="col-md-12 mb-3">
            ...
            <input type="text" class="form-control" id="diagnosisTitle" name="diagnosisTitle" placeholder="Enter the title of the diagnosis" pattern="[A-Za-z0-9\s_-/]+" required value="{{ old('diagnosisTitle', $singleDiagnosis->diagnosis_title) }}">
        </div>

        <div class="col-md-6 mb-3">
            <label for="startDate" class="form-label">Starting date of Diagnosis</label>
            <input class="form-control" type="date" id="startDate" name="startDate" min="2000-01-01" max="2050-12-31" value="{{ old('startDate', $singleDiagnosis->diagnosis_startdate) }}">
        </div>
        <div class="col-md-6 mb-3">
            <label for="endDate" class="form-label">Ending date of Diagnosis</label>
            <input class="form-control" type="date" id="endDate" name="endDate" min="2000-01-01" max="2050-12-31" value="{{ old('endDate', $singleDiagnosis->diagnosis_enddate) }}">
        </div>

        <div class="col-md-12 mb-4">
    <label class="form-label">Severity</label>
    <div class="form-check">
        <input class="form-check-input" type="radio" name="severity" id="lowSeverity" value="Low" {{ $singleDiagnosis->severity == 'Low' ? 'checked' : '' }}>
        <label class="form-check-label" for="lowSeverity">Low</label>
    </div>
    <div class="form-check">
        <input class="form-check-input" type="radio" name="severity" id="moderateSeverity" value="Moderate" {{ $singleDiagnosis->severity == 'Moderate' ? 'checked' : '' }}>
        <label class="form-check-label" for="moderateSeverity">Moderate</label>
    </div>
    <div class="form-check">
        <input class="form-check-input" type="radio" name="severity" id="extremeSeverity" value="Extreme" {{ $singleDiagnosis->severity == 'Extreme' ? 'checked' : '' }}>
...
<div class="row">
    <div class="col-md-12 mb-3 text-end">
        <a href="./patients-medication-report.html" class="btn btn-secondary me-2">Cancel</a>
