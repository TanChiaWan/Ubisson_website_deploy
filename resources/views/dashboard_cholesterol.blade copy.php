            ...
            <div class="col-sm-9">
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="tabtitle">
                                <a href="{{ route('dashboard_general', ['patientId' => $patient->patient_id]) }}">General</a><a href="{{ route('dashboard_bg', ['patientId' => $patient->patient_id]) }}">BG</a><a href="{{ route('dashboard_bp', ['patientId' => $patient->patient_id]) }}"  >BP</a><a href="{{ route('dashboard_cho', ['patientId' => $patient->patient_id]) }}" class="active">Cholesterol</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="button_evt_date">
                        <select class="event_slt" name="event_type" id="event_type" onchange="location = this.value;">
                            <option value="{{ route('dashboard_bp', ['patientId' => $patient->patient_id]) }}">Blood Pressure</option>
                            <option value="{{ route('dashboard_bg', ['patientId' => $patient->patient_id]) }}">Blood Glucose</option>
                            <option value="{{ route('dashboard_cho', ['patientId' => $patient->patient_id]) }}"selected>Cholesterol</option>
                        </select>
                            ...
                            <div class="container_hyper_events">
                                ...
                                <script defer>
                                    ...
                                    const data = {
                                        ...
                                        choValues: [1, 3, 4, 3, 2, 1, 3],
                                        ldlValues: [2, 1, 3, 2, 2, 3, 2],
                                        hdlValues: [3, 2, 1, 1, 1, 3, 2]
                                    };
                                        ...
                                        data: {
                                            ...
                                            datasets: [
                                                ...
                                                },
                                                {
                                                    label: 'HDL',
                                                    data: data.hdlValues,
                                                    backgroundColor: 'rgba(255,195,105, 0.5)',
                                                    borderColor: 'rgba(255,195,105, 1)',
                                                    borderWidth: 1
                                                }
                                            ]
                                          },
