  ...
  <!--  Body Wrapper -->
       ...
       <div class="container-fluid">
        ...
        <div class="row mb-3">
          ...
          <form id="diagnosisForm" method="POST" action="{{ route('store.diagnosis.medication') }}">
          <div class="container-fluid">
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    <h5 class="card-title fw-semibold mb-4">Create Patient Diagnosis</h5>
                   
                  </div>
                 
    <div class="col-md-6">
        <div class="form-check form-switch" style="float: right;">
        <input class="form-check-input flexSwitchCheckChecked" type="checkbox" name="active" id="flexSwitchCheckChecked" checked value="1">
...
<div class="row">
    <div class="col-md-12 mb-3">
        ...
        <input type="text" class="form-control" id="diagnosisTitle" name="diagnosisTitle" placeholder="Enter the title of the diagnosis" pattern="[A-Za-z0-9\s_-/]+" required>
    </div>

    <div class="col-md-6 mb-3">
        <label for="startDate" class="form-label">Starting date of Diagnosis</label>
        <input class="form-control" type="date" id="startDate" name="startDate" value="2022-07-22" min="2000-01-01" max="2050-12-31">
    </div>
    <div class="col-md-6 mb-3">
        <label for="endDate" class="form-label">Ending date of Diagnosis</label>
        <input class="form-control" type="date" id="endDate" name="endDate" value="2022-07-22" min="2000-01-01" max="2050-12-31">
    </div>

    <div class="col-md-12 mb-4">
        <label class="form-label">Severity</label>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="severity" id="lowSeverity" value="Low">
            <label class="form-check-label" for="lowSeverity">Low</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="severity" id="moderateSeverity" value="Moderate">
            <label class="form-check-label" for="moderateSeverity">Moderate</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="severity" id="extremeSeverity" value="Extreme">
...
<h5 class="card-title fw-semibold mb-4 mt-2">Create Patient Medication</h5>
<div class="row">
    <div class="col-md-12 mb-3">
