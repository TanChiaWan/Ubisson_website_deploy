    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <h5 class="card-title fw-semibold mb-2">Permissions</h5>
                        @if ($permissionCount>2)
                        <p class="mb-3">{{$permissionCount}} permissions</p> 
                        @else
                        <p class="mb-3">{{$permissionCount}} permission</p>
                        @endif 
                    </div>
                </div>
                      ...
                      @foreach($permissions as $permissions)
                        <tr>
                          <td class="border-bottom-0">
                            <p class="mb-0 fw-normal">{{ $permissions->name }}</p>
                          </td>
                          <td class="border-bottom-0">
                            <p class="mb-0 fw-normal">{{ $permissions->permission_category }}</p>                    
                          </td>
                          <td class="border-bottom-0">
                            <p class="mb-0 fw-normal">{{ $permissions->created_at }}</p>
                          </td>
                          <td class="border-bottom-0">
                            <p class="mb-0 fw-normal">{{ $permissions->updated_at }}</p>
                          </td>
