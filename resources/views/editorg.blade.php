...
<div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Update Organization</h5>
            <?php
            $inputValue = $organization->customized_login_url;

            // Extract the numeric value from the URL
            $value = basename($inputValue);
    ...
    @endif
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input name='organization_name' type="text" class="form-control" id="organization-update-input-name organization_name" value="{{ $organization->organization_name }}" required>
                    </div>
                    <div class="col-md-6 mb-3">
                      ...
                      <div class="input-group mb-3">
                        ...
                        <input name="customized_login_url" type="text" class="form-control" id="organization-update-input-url customized_login_url" aria-describedby="organiztion-url-addon" value="{{ $value }}" required>
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                      ...
                      <input name="address" type="text" class="form-control" id="organization-update-input-address address" value="{{ $organization->address }}" required>
                  </div>
                  <div class="col-md-6 mb-3">
                    <label for="organization-update-input-phone" class="form-label">Mobile Phone</label>
                    <input  name="organization_mobile_phone" type="text" class="form-control" id="organization-update-input-phone organization_mobile_phone" value="+{{ $organization->organization_mobile_phone}}" required>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                      ...
                      <input name="administrator_name" type="text" class="form-control" id="organization-update-input-adminname administrator_name" value="{{ $organization->administrator_name }}" required>
                  </div>
                  <div class="col-md-6 mb-3">
                    <label for="organization-update-input-adminemail" class="form-label">E-mail Address</label>
                    <input name="administrator_email_address" type="email" class="form-control" id="organization-update-input-adminemail administrator_email_address" value="{{ $organization->administrator_email_address }}" required>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6 mb-3">
                      <label for="organization-update-input-username" class="form-label">Username</label>
                      <input name="administrator_username" type="text" class="form-control" id="organization-update-input-username administrator_username" value="{{$organization->administrator_username}}" required>
                  </div>
                </div>
                ...
                <a href="{{ route('updateorganization', ['organizationid' => $organization->organizationid]) }}" class="btn btn-secondary m-2">Cancel</a>
              </form>
