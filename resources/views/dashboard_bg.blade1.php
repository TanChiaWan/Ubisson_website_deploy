            ...
            <div class="col-sm-9">
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="tabtitle">
                                <a href="{{ route('dashboard_general', ['patientId' => $patient->patient_id]) }}">General</a><a href="{{ route('dashboard_bg', ['patientId' => $patient->patient_id]) }}" class="active">BG</a><a href="{{ route('dashboard_bp', ['patientId' => $patient->patient_id]) }}" >BP</a><a href="{{ route('dashboard_cho', ['patientId' => $patient->patient_id]) }}">Cholesterol</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="button_evt_date">
                        <select class="event_slt" name="event_type" id="event_type" onchange="location = this.value;">
                            ...
                            <option value="{{ route('dashboard_bg', ['patientId' => $patient->patient_id]) }}" selected>Blood Glucose</option>
