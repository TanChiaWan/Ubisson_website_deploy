...
<div class="container-fluid">
        <div class="card">
            <div class="card-body">
              ...
              <form action="{{ route('insert2.createorg') }}" method="POST" enctype="multipart/form-data">
              @csrf
                    ...
                    <div class="row">
                      <div class="col-md-6 mb-3">
                          <label for="patient-list-aboutpatient-organisation" class="form-label">Organisation</label>
                            ...
                            <!-- Displayed select field with organization names -->
                            <select class="form-select" name="organization_name" id="organization_name" required disabled>
                                @foreach($organizations as $organization)
                                    <option value="{{ $organization->organization_name }}" {{ $organization->organizationid == session('organizationid') ? 'selected' : '' }}>
