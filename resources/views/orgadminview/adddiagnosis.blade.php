  ...
  <!--  Body Wrapper -->
       ...
       <div class="container-fluid">
          ...
          <div class="card d-inline-block">
            <div class="card-body py-1 px-4">
              <div class="row text-center">
                ...
                <a href="{{ route('remarkorg') }}" class="btn btn-light m-1 btn-pagenav-notselecteds">Remarks</a>
        ...
        <div class="row mb-3">
          ...
          <form id="diagnosisForm" method="POST" action="{{ route('store.diagnosis.medicationorg') }}">
          <div class="container-fluid">
            <div class="card">
              <div class="card-body">
                <div class="row">
