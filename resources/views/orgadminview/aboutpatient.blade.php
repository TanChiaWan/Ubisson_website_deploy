...
<div class="container-fluid">
    ...
    <a href="{{ route('aboutpatientorg') }}" class="btn btn-primary m-1 active">About Patient</a>
        ...
        <div class="card">
          <div class="card-body">
            <div class="row">
              ...
              <form action="{{ route('editpageorg') }}" method="POST" style='display:inline-block;'>
                          @csrf
                ...
                <form>
                    ...
                    <div class="row">
                      ...
                      @if (filter_var($patient->patient_image, FILTER_VALIDATE_URL))
                                                                                    ...
                                                                                    @else
                                                                                        <img id="profile-picture" class="rounded float-left img-fluid" style="cursor: unset;" src="{{ asset('storage/' . $patient->patient_image) }}" alt="Uploaded Image">
                                                                                    @endif
                  ...
                  <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-md-6 text-end mb-4">
                          <a href="{{ route('edit_patient_glucose_targetorg') }}" class="btn btn-primary btn-with-icon align-items-center"><i class="ti ti-pencil"></i>Edit</a>
                        </div>
                        <div class="col-md-6 mb-3">
                ...
                <div class="card">
                  <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-md-6 text-end mb-4">
                          <a href="{{ route('edit_patient_target_rangeorg') }}" class="btn btn-primary btn-with-icon align-items-center"><i class="ti ti-pencil"></i>Edit</a>
                        </div>
                        <div class="col-md-6 mb-3">
