...
<div class="container-fluid">
        ...
        <div class="card">
            ...
            <form action="{{ route('logbook.searchorg') }}" method="post">
            @csrf
...
foreach ($results2 as $result) {
    ...
    if ($patient && $criteria3 !== '0' && $criteria4 !== '0' && $criteria3 > $criteria4) {
        ...
        if ($result->bp_level > $criteria3) {
            $patientData[$patient->patient_id]['biggercriteria3'][] = $result->bp_level;
        } elseif ($result->bp_level > $criteria2 && $criteria1 > $result->bp_level) {
            $patientData[$patient->patient_id]['betweencriteria4'][] = $result->bp_level;
        } elseif ($result->bp_level > $patient->targetBG_high_BC && $result->bp_level < $criteria2) {
