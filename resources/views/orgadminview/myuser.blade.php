        ...
        <div class="card">
          <div class="card-body">
            <div class="row">
              ...
              <form action="{{ route('editmyuserorg') }}" method="GET">
                  @csrf
                  <input type="hidden" name="professional_id" value="{{ $professionalss->professional_id }}">
                  <button type="submit" class="btn btn-primary btn-with-icon align-items-center">
            ...
            <form>
                ...
                <div class="row">
                      ...
                      @else
                          ...
                          <img id="profile-picture" class="rounded float-left img-fluid"style="cursor: unset;" src="{{ asset('storage/' . $professionalss->professional_image) }}">
                ...
                <a href="{{ route('all_userorg') }}" class="btn btn-primary">Back</a>
            </form>
