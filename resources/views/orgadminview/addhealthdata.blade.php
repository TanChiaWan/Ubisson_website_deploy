...
<div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Add Health Data</h5>
              
            <form action="{{ route('create.healthdataorg', ['patient_id' => $patient->patient_id]) }}" method="POST">
            @csrf
    ...
    @endif
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="datetime-local" class="form-control" id="healthdata-add-datetime" name='healthdata-add-datetime' required>
                    </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-3 mb-3">
                      ...
                      <div class="input-group mb-3">
                        <input type="number" class="form-control" id="healthdata-add-weight" name='healthdata-add-weight' aria-describedby="healthdata-weight-addon" step="0.01" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-height" name="healthdata-add-height" aria-describedby="healthdata-height-addon" step="0.01" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-sbp" name="healthdata-add-sbp" aria-describedby="healthdata-sbp-addon" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-dbp" name="healthdata-add-dbp" aria-describedby="healthdata-dbp-addon" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-pulse" name="healthdata-add-pulse" aria-describedby="healthdata-pulse-addon" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-celsius"  name="healthdata-add-celsius" aria-describedby="healthdata-celsius-addon" step="0.1" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-fahrenheit" name="healthdata-add-fahrenheit" aria-describedby="healthdata-fahrenheit-addon" step="0.1" required>
                ...
                <div class="row">
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-a1cpercentage" name="healthdata-add-a1cpercentage" aria-describedby="healthdata-a1cpercentage-addon" step="0.1" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-lotview" name="healthdata-add-lotview" aria-describedby="healthdata-lotview-addon" placeholder="optional">
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-instid" name="healthdata-add-instid" aria-describedby="healthdata-instid-addon" placeholder="optional">
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-testid" name="healthdata-add-testid" aria-describedby="healthdata-testid-addon" placeholder="optional">
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-operator" name="healthdata-add-operator"  aria-describedby="healthdata-operator-addon" step="0.001" placeholder="optional">
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-ga" name="healthdata-add-ga" aria-describedby="healthdata-ga-addon" step="0.001">
                ...
                <div class="row">
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-cho" name="healthdata-add-cho"  aria-describedby="healthdata-cho-addon" step="0.001" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-hdl" name='healthdata-add-hdl' aria-describedby="healthdata-hdl-addon" step="0.001" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-ldlc" name="healthdata-add-ldlc" aria-describedby="healthdata-ldlc-addon" step="0.001" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-tg" name="healthdata-add-tg" aria-describedby="healthdata-tg-addon" step="0.001" required>
                ...
                <div class="row">
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-cpeptide" name="healthdata-add-cpeptide" aria-describedby="healthdata-cpeptide-addon" step="0.001" required>
                ...
                <div class="row">
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-ckdstage" name="healthdata-add-ckdstage" aria-describedby="healthdata-ckdstage-addon" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-cre" name="healthdata-add-cre" aria-describedby="healthdata-cre-addon" step="0.001" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-ua" name="healthdata-add-ua" aria-describedby="healthdata-ua-addon" step="0.001" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-egfr" name="healthdata-add-egfr" aria-describedby="healthdata-egfr-addon" step="0.001" required>
                ...
                <div class="row">
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-acr" name="healthdata-add-acr" aria-describedby="healthdata-acr-addon" step="0.001" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-ma" name='healthdata-add-ma' aria-describedby="healthdata-ma-addon" step="0.001" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-pro" name='healthdata-add-pro' aria-describedby="healthdata-pro-addon" step="0.001" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-upcr" name='healthdata-add-upcr' aria-describedby="healthdata-upcr-addon" step="0.001" required>
                ...
                <div class="row">
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-ca" name="healthdata-add-ca" aria-describedby="healthdata-ca-addon" step="0.001" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-k" name="healthdata-add-k" aria-describedby="healthdata-k-addon" step="0.001" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-na" name="healthdata-add-na" aria-describedby="healthdata-na-addon" step="0.001" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-p" name="healthdata-add-p" aria-describedby="healthdata-p-addon" step="0.001" required>
                ...
                <div class="row">
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-gptalt" name="healthdata-add-gptalt" aria-describedby="healthdata-gptalt-addon" step="0.001" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                      <input type="number" class="form-control" id="healthdata-add-got" name="healthdata-add-got" aria-describedby="healthdata-got-addon" step="0.001" required>
                      <span class="input-group-text" id="healthdata-got-addon">U/L</span>
                    </div>
                  </div>
                </div>
                <button type="submit" class="btn btn-primary">Submit</button>
                <a href="{{ route('healthdataorg') }}" class="btn btn-secondary mx-2">Cancel</a>
            </form>
