                ...
                <div class="modal-dialog modal-dialog-centered modal-sm">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <form action="{{ route('deletes') }}" method="POST" style='display:inline-block;'>
                          @csrf

                        <input type="hidden" name="healthdata_id" value="{{ $singleHealthData->healthdata_id }}">
                        <input type="hidden" name="patient_id" value="{{ $patient->patient_id }}" >
                        <input type="hidden" name="professional_id" value="{{ $user->professional_id }}">
                ...
                <table class="table text-nowrap mb-0 align-middle datatable">
                    ...
                    <tr>
                        <td class="border-bottom-0">
                            ...
                            <form id="editHealthDataForm" action="{{ route('edithealthdata', ['healthdata_id' => $data->healthdata_id]) }}" method="POST" style="display: inline;">
                                @csrf
                                <input type="hidden" name="patient_id" value="{{ $patient->patient_id }}" >
                        <input type="hidden" name="professional_id" value="{{ $user->professional_id }}">
