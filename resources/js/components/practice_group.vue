...
<div class="col-md-4"  v-for="group in practice_groups" :key="group.practice_group_id">
  <a :href="`${myAboutPatientRoute}/${group.practice_group_id}`" style="text-decoration: none; color: inherit;">
    <div class="card">
      <div class="card-body">
        <div class="row">
...
export default {
  ...
  data() {
    return {
      myAboutPatientRoute: '/praticegroupdetail',
